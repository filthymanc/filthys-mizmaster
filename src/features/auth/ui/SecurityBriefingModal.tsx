...
const SecurityBriefingModal: React.FC<SecurityBriefingModalProps> = ({
  isOpen,
  onClose,
}) => {
      ...
      >
        ...
        <div className="flex justify-between items-center p-4 sm:p-6 border-b border-app-border bg-app-canvas/50">
          <div className="flex items-center gap-3">
            ...
            <h2
              id="security-briefing-title"
              className="text-xl font-bold text-app-primary"
            >
              Security Briefing
            </h2>
          </div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-6 text-app-secondary text-sm leading-relaxed custom-scrollbar">
          <section className="space-y-3">
            ...
            <p>
              MizMaster requires direct access to Google's Gemini AI to
              interpret mission data and generate code. By providing your own
              API key, you ensure a direct, unmediated connection between your
              device and Google's servers.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Google offers a generous Free Tier for the Gemini API. By using
              your own key, you operate under your own quotas. You can monitor
              usage and set limits directly within Google AI Studio to prevent
              unexpected charges.
            </p>
            <div className="mt-2">
              <a
          ...
          <section className="space-y-3 p-4 bg-app-canvas rounded-lg border border-app-border">
            ...
            <p>
              While the AI is powerful, it is not infallible. Our core
              philosophy is <strong>"Verify before Writing"</strong>. The AI is
              designed to act as a highly capable assistant, but you remain the
              commanding officer. Always review generated code and logic before
              deployment.
            </p>
          </section>
        </div>
